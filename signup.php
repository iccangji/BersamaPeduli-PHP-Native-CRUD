...
<body class="bg-light">
  <div class="jumbotron-about p-5">
    ...
    <!-- nav -->
    <div class="container w-50 bg-white mt-5 text-center">
      <form action="data-account.php" method="post" class="p-5 rounded login-form">
        <h3 class="donate-title">Daftar</h3>
        ...
        <button type="submit" name="btnAcc" value="Daftar" class="btn btn-secondary w-100 btn-donate">Daftar</button>
      </form>
    </div>
  </div>
